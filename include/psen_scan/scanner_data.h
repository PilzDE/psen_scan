...
std::size_t const PSEN_SCAN_PORT_WRITE = 3000; /**< Port on which Laserscanner expects messages */
std::size_t const PSEN_SCAN_PORT_READ = 2000;  /**< Port from which Laserscanner sends messages */
